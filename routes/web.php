...
Route::middleware(['auth'])->group(function () {
    ...
    Route::middleware(['role:admin'])->prefix('admin')->group(function () {
        // Ini rute yang tadi bikin 404, sekarang sudah didaftarkan:
        Route::get('/dashboard', [AdminController::class, 'index'])->name('admin.dashboard.admin');
    ...
    Route::middleware(['role:siswa'])->group(function () {
        Route::get('/dashboard', [AdminController::class, 'index'])->name('siswa.dashboard');
...
Route::middleware(['role:guru'])->prefix('guru')->group(function () {
    Route::get('/dashboard', [AdminController::class, 'index'])->name('guru.dashboard');
});
...
Route::middleware(['role:kepsek'])->prefix('kepsek')->group(function () {
    Route::get('/dashboard', [AdminController::class, 'index'])->name('kepsek.dashboard');
});
